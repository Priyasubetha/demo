...
<title>Edit or Assign Quiz</title>
...
<body class="bg-secondary">
	...
	<div class="container">
			<form action="QuizInfo.jsp" method="post">
			...
			<div class="text-center ">
				<button type="submit" class="btn btn-warning col-md-2">EDIT QUIZ</button>
				<button type="submit" formaction="QuizList.jsp" class="btn btn-warning col-md-2 ms-5">ASSIGN</button>
			</div>
			</form>	
